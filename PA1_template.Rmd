...
par(mfrow = c(2,1))
plot(levels(intervals_factor), StepsPerDay_weekday_indicator$weekday, type = "l", main = "Weekdays", xlab = "Intervals", ylab = "Average Steps")
plot(levels(intervals_factor), StepsPerDay_weekday_indicator$weekend, type = "l", main = "Weekend", xlab = "Intervals", ylab = "Average Steps")
